...
<%@taglib prefix="ithemima" uri="http://itheima.com/common/" %>
<%
    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" method="post" id="customer_from"
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <ithemima:page url="${pageContext.request.contextPath}/customer/list"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="new_customer_form" action="/customer/save" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="new_custIndustry" name="cust_industry">
                                ...
                                <c:forEach items="${industryType}" var="item">
                                    <option value="${item.dict_id}" <c:if
                                            test="${item.dict_id==custIndustry}">selected</c:if>>${item.dict_item_name}
                                    </option>
                                </c:forEach>
                            </select>
                        </div>
...
<script>
    ...
    //创建客户
    function customer() {
        $.post("<%=basePath%>customer/save", $("#new_customer_form").serialize(), function (data) {
            if (data == "OK") {
                alert("客户创建成功！");
    ...
    function updateCustomer() {
        $.post("<%=basePath%>customer/save", $("#edit_customer_form").serialize(), function (data) {
            if (data == "OK") {
                alert("客户修改成功！");
                window.location.reload();
            } else {
    ...
    function deleteCustomer(id) {
        if (confirm('确定要删除该客户吗？')) {
            $.post("<%=basePath%>customer/deleteCustomer", {"id": id}, function (data) {
                    if (data == "OK") {
                        alert("客户删除成功！");
                        window.location.reload();
                    } else {
